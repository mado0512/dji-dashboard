...
description: Svelte 5 best practices: $state/$derived/$effect rules, event handling, styling, context, snippets, each blocks, and legacy-avoidance guidance.
---

# Svelte 5 Core Best Practices

Guidance on writing fast, robust, modern Svelte code. Load this skill whenever writing, editing, or analyzing a Svelte component or module.
